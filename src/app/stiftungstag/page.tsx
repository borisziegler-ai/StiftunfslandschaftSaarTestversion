...
// Bilder innerhalb eines bestimmten Ordners auflisten
...
export default function StiftungstagPage() {
  const folders = listFolders("stiftungstag"); // sucht stiftungstag2024, stiftungstag2025 …
